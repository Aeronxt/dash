      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-16">
          <div className="flex flex-col items-center">
            ...
            <div className="h-6 bg-gray-800 rounded w-40 mb-2 animate-pulse"></div>
            <div className="h-4 bg-gray-800 rounded w-88 mb-6 animate-pulse"></div>
            <div className="h-10 bg-gray-800 rounded-lg w-56 animate-pulse"></div>
          </div>
        </div>
      </div>
    </div>
