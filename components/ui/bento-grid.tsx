...
function BentoGrid({ items = itemsSample }: BentoGridProps) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 max-w-full mx-auto">
            {items.map((item, index) => (
                <div
                    ...
                    className={cn(
                        ...
                        "hover:-translate-y-0.5 will-change-transform min-h-[180px]",
                ...
                >
                    ...
                    <div className="relative flex flex-col space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-base text-gray-600 dark:text-gray-300 leading-relaxed font-[425]">
                                {item.description}
                            </p>
                        </div>
                        ...
                        <div className="flex items-center justify-between mt-4">
                            <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                                {item.tags?.map((tag, i) => (
                                    <span
                                        key={i}
                                        className="px-3 py-1.5 rounded-md bg-black/5 dark:bg-white/10 backdrop-blur-sm transition-all duration-200 hover:bg-black/10 dark:hover:bg-white/20"
                                    >
                                        #{tag}
                                    </span>
                                ))}
